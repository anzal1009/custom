...
class SaleCurrency(models.Model):
    ...
    usd_rate =fields.Float(string='Currency Rate',compute='_compute_usd_rate',store=True)

    @api.depends('pricelist_id','date_order')
...
class InvoiceCurrency(models.Model):
    ...
    usd_rates =fields.Float(string='Currency Rate')
...
class PaymentCurrency(models.Model):
    ...
    usds_rates =fields.Float(string='Currency Rate')

...
class IrnInherit(models.Model):
    ...
    TransDocDt = fields.Date(string="Transaction Date *")
    ...
    partner = fields.Many2one('res.partner', string="Partners")
...
class SaleOrderInherit(models.Model):
    ...
    #     print("okeyy")
    #     url = "https://einvoicing.internal.cleartax.co/v2/eInvoice/download"
    #     headers = {"Content-type": "application/pdf",
    #                "x-cleartax-auth-token": "1.0e34e660-c559-4ad5-ab87-b53547ebd091_8f680e5750e447de7676af3ba12197022d98029bdae09955fe1b332a99e6e391",
    #                "x-cleartax-product": "EInvoice", "owner_id": "92323c20-5ac0-45e0-96dc-e220122d51be",
    ...
    def action_print_e_way(self):
        print("aaa")
        url = "https://einvoicing.internal.cleartax.co/v2/eInvoice/ewaybill/print"
        headers = {"Content-type": "application/json",
                   "x - cleartax - auth - token": "1.0e34e660-c559-4ad5-ab87-b53547ebd091_8f680e5750e447de7676af3ba12197022d98029bdae09955fe1b332a99e6e391",
                   "x - cleartax - product": "EInvoice",
                   "owner_id": "853ad3de-eff3-478b-a07e-31e2c69b8486",
                   "gstin": "32AAACE6765D1ZX"
                   }
        ...
        req = requests.put(url, data=json.dumps(Eway_Data), headers=headers, timeout=50)
    ...
    def action_generate_irn(self):
        ...
        for items in self.invoice_line_ids:
            ...
            if items.tax_ids.name.startswith('GST'):
                ...
                print('igst')
                GstRt = items.tax_ids.amount
                GstAmt = (items.quantity * items.price_unit) * (items.discount / 100)*( items.tax_ids.amount) / 100
                IgstAmt = GstAmt
                CgstAmt = 0.0
                SgstAmt = 0.0
